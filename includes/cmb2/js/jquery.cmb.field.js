...
( function( $ ) {
	$( document ).ready( function() {
		...
		$( '#_bethemesme_option_icon_service_box_repeat' ).find( '.cmb-repeatable-grouping' ).each( function() {
		...
		$( '#_bethemesme_option_contact_box_repeat' ).find( '.cmb-repeatable-grouping' ).each( function() {
