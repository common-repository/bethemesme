<section id="contact" class="module onepage_contact_module clearfix">
	<div class="container">
		<div class="row">
			...
			<div class="contact-form col-md-8  col-sm-8 col-12 clearfix">
				...
				<form id="contact-form" class="contact-form onepage_contact_form clearfix">
					...
					<fieldset class="submit col-sm-6">
						...
						<button class="btn onepage_btn_text" type="submit" id="contact-form-submit" name="submit" value="submit"><span><?php echo $settings['section_send_btn_text']; ?></span></button>
