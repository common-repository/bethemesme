<section class="onepage_portfolio">
	<div class="portfolio_el_container">
		<?php
		...
		<div class="portfolio-wrap-loader">
			<div class="portfolio-wrap clearfix" data-itemcolumn="4">
				<?php
				if(isset($settings['portfolio_item_number_to_show']) && !empty($settings['portfolio_item_number_to_show']) ){
					$onepage_portfolio_post_number = $settings['portfolio_item_number_to_show'];
				}else{
					$onepage_portfolio_post_number = -1;
				}
				$display_showall_button = "";	
					...
					$display_showall_button = '<div class="clearfix"><a href="'.$display_showall_button_url.'" target="_blank" class="btn onepage_btn_text"><span>'.$number_of_portfolio_showall_button_text.'</span></a></div>';

				$args = array(
					'post_type' => 'portfolio',
					'posts_per_page' => $onepage_portfolio_post_number,
				);
